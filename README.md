...
|  3.   | <details><summary><a href="#3-learn-essential-data-structures-and-algorithms"><b>Learn essential Data Structures and Algorithms, including:</b></a></summary><p>◌ <a href="#dsa-basic-to-advanced">3.1 - Array</a><br>◌ <a href="#dsa-basic-to-advanced">3.2 - String</a><br>◌ <a href="#dsa-basic-to-advanced">3.3 - Linked List</a><br>◌ <a href="#dsa-basic-to-advanced">3.4 - Searching Algorithm</a><br>◌ <a href="#dsa-basic-to-advanced">3.5 - Sorting Algorithm</a><br>◌ <a href="#dsa-basic-to-advanced">3.6 - Divide and Conquer Algorithm</a><br>◌ <a href="#dsa-basic-to-advanced">3.7 - Stack</a><br>◌ <a href="#dsa-basic-to-advanced">3.8 - Queue</a><br>◌ <a href="#dsa-basic-to-advanced">3.9 - Tree Data Structure</a><br>◌ <a href="#dsa-basic-to-advanced">3.10 - Graph Data Structure</a><br>◌ <a href="#dsa-basic-to-advanced">3.11 - Greedy Methodology</a><br>◌ <a href="#dsa-basic-to-advanced">3.12 - Recursion</a><br>◌ <a href="#dsa-basic-to-advanced">3.13 - Backtracking Algorithm</a><br>◌ <a href="#dsa-basic-to-advanced">3.14 - Dynamic Programming</a></p></details> |
